...
//Les defines
//pour les agents
#define NB_AGENTS 40			//le nombre de boules dans ma simulation
...
#define SEUIL_BUT 0.005			//dans cette fourchette l'agent estime qu'il a atteint son but
...
#define FOSSE 0.25 //0.3
#define MASSE_BLOC 10000.0
#define COULEUR_BLOC 0.3,0.7,1//0,0,1
...
#define COEFF_FROTTEMENTS dInfinity//0
#define COEFF_FROTTEMENTS_AGENTS 15//dInfinity//0
